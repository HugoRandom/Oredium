...
public enum ArmorOredium implements IArmorMaterial{
	...
	HUGODIUM("oredium:hugodium", 33, new int[]{5, 8, 10, 5}, 11, SoundEvents.ARMOR_EQUIP_NETHERITE, 2.0F, 0.5F, () -> { return Ingredient.of(ItemInit.HUGODIUM_INGOT.get()); }),
	ALEZARITA("oredium:alezarita", 31, new int[]{4, 8, 10, 4}, 12, SoundEvents.ARMOR_EQUIP_NETHERITE, 1.5F, 0.2F, () -> { return Ingredient.of(ItemInit.ALEZARITA_INGOT.get()); }),
	AXIDITA("oredium:axidita", 28, new int[]{3, 6, 8, 3}, 12, SoundEvents.ARMOR_EQUIP_DIAMOND, 0.5F, 0.0F, () -> {return Ingredient.of(ItemInit.AXIDITA.get()); }),
	...
	CESARITA("oredium:cesarita", 28, new int[]{3, 6, 8, 3}, 10, SoundEvents.ARMOR_EQUIP_DIAMOND, 1.5F, 0.1F, () -> { return Ingredient.of(ItemInit.CESARITA_INGOT.get()); }),
	...
	ENDERIUM("oredium:enderium", 33, new int[]{4, 7, 9, 4}, 20, SoundEvents.ARMOR_EQUIP_NETHERITE, 3.0F, 0.1F, () -> { return Ingredient.of(ItemInit.ENDERIUM_INGOT.get()); });
