...
public class ShineParticle extends SpriteTexturedParticle{
	...
	protected ShineParticle(ClientWorld worldIn, double xCoordIn, double yCoordIn, double zCoordIn,
		...
		this.yd *= 0.015D;
		this.zd *= 0.015D;
		this.age = (int) (10.0D/(Math.random() * 1.0D));
	}
	...
	public static class Factory implements IParticleFactory<BasicParticleType>{
		...
		public Particle createParticle(BasicParticleType typeIn, ClientWorld worldIn, double x,
			...
			ShineParticle xShineParticle = new ShineParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed);
			xShineParticle.pickSprite(spriteSet);
			return xShineParticle;
		}
