...
@OnlyIn(Dist.CLIENT)
public class EnderiumParticle extends SpriteTexturedParticle{

	protected EnderiumParticle(ClientWorld worldIn, double xCoordIn, double yCoordIn, double zCoordIn,
	...
	public static class Factory implements IParticleFactory<BasicParticleType>{
		...
		public Particle createParticle(BasicParticleType typeIn, ClientWorld worldIn, double x,
			...
			EnderiumParticle xEnderiumParticle = new EnderiumParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed);
			xEnderiumParticle.pickSprite(spriteSet);
			return xEnderiumParticle;
		}
